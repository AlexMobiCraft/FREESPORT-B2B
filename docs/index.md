...
- **[Обоснование по форме входа](./legal/login-form-consent-justification.md)** — почему чекбокс согласия на `/login` не добавляется: аутентификация не является сбором ПДн, согласие зафиксировано в `UserConsent` при регистрации.
