    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-16">
        <InfoPanel
          ...
          message="На всех этапах сотрудничества с вами работает персональный специалист. Он поможет подобрать товар, оформить заказ, проконсультирует по всем вопросам и обеспечит своевременную доставку."
        />
      </section>
      ...
      <section id="returns" className="mb-16 scroll-mt-24">
        ...
        <div className="mx-auto max-w-3xl rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
          ...
          <ol className="list-inside list-decimal space-y-2 text-gray-700">
            ...
            <li>Направить акт и фотографии специалисту в течение 24 часов с момента получения</li>
            <li>
