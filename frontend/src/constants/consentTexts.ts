...
export const CONSENT_TEXT_VERSIONS = {
   ...
   * Ревизия `2026-09-21-newsletter` ссылается на полный текст «Согласия на получение
   * рекламы» (`/marketing-consent`). Текст дословно совпадает с ревизией регистрации —
   * версии различает метка.
   */
  newsletterMarketing: '2026-09-21-newsletter-b96d601aed0fd4809c3b0fa3171c1b45',
   ...
   * Ревизия `2026-09-21-registration` ссылается на полный текст «Согласия на получение
   * рекламы» (`/marketing-consent`). Текст дословно совпадает с ревизией подписки —
   * версии различает метка.
   */
  registrationMarketing: '2026-09-21-registration-b96d601aed0fd4809c3b0fa3171c1b45',
} as const;
